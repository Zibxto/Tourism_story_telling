  ...
  <button class="btn mobile m-icon" id="m-close" onclick="menu()">
    ...
    <div class="col-sm-8" id="overlay">
      <ul class="c-menu desktop bold" id="show">
        <li><a href="index.php">Manage Members</a></li>
        <li><a href="manage_story.php">Manage Stories</a></li>
        <li><a href="../dashboard/profile.php">Manage Profile</a></li>
      </ul>
      
    </div>

    <div class="col-sm-2">
      <button type="button" class="btn btn-primary mt-4 logout-btn"><a href="../dashboard/logout.php" >SIGN OUT </a></button>
      
    </div>

    <div>
      <h5 style="color: #f2f2f2; text-shadow: 2px 2px 2px #222;">Welcome Admin: <?php echo $q_row['firstname']." ".$q_row['lastname']; ?></h5>
    </div>
